...
| [003](https://projecteuler.net/problem=3)  | [003.py](python/003.py) | | **Easy** | While the brute force approach can be optimized, I also learned about Pollard's algorithm which performs substantially better for larger numbers. |
