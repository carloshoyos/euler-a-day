...
| [076](https://projecteuler.net/problem=76)  | [076.py](python/076.py) | | **Easy-10%** |  love this problem, many ways to solve (dynamic programming, recursion). Problem 31 solved a simpler version of this.   | ,  |
