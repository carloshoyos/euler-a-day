...
| [066](https://projecteuler.net/problem=66)  | [066.py](python/066.py) | | **Easy-25%** |  Mind blown that you can use continuous fractions to solve a specific dyophantine equation (Pell's equation). A naive approach would never work. | continuous fractions, Pell's equation, dyophantine | 
