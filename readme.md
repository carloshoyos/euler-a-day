...
| [072](https://projecteuler.net/problem=72)  | [072.py](python/072.py) | | **Easy-10%** |  Connecting dots, the totient phi function helps counting reduced fractions.  | integer fractions, reduced proper fraction, phi, totient  |
| [073](https://projecteuler.net/problem=73)  | [073.py](python/073.py) | | **Easy-10%** |  Using simple arithmetic, was able to simplify the problem to test only one condition per digit.  Brute force iterate over the simplified problem to find the answer.  | integer fractions, reduced proper fraction  |
| [074](https://projecteuler.net/problem=74)  | [074.py](python/071.py) | | **Easy-10%** |  Using simple arithmetic, was able to simplify the problem to test only one condition per digit.  Brute force iterate over the simplified problem to find the answer.  | integer fractions, reduced proper fraction  |